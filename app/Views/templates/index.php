...
<head>
    ...
    <link rel="apple-touch-icon" href="<?= base_url(); ?>/img/logoweb.png">
    <link rel="shortcut icon" type="image/x-icon" href="<?= base_url(); ?>/img/logoweb.png">

    <link rel="stylesheet" href="<?= base_url(); ?>/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?= base_url(); ?>/css/templatemo.min.css">
...
<body>
                    ...
                    <div class="row p-5">
                        ...
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left align-self-center">
                                <h1 class="h1 text-success"><b>e-Shopindo</b> eCommerce</h1>
                                <h3 class="h2">Perfect eCommerce</h3>
                                <p>
    ...
    <script src="<?= base_url(); ?>/js/templatemo.min.js"></script>
